class ConversationsController < ApplicationController
  ...
  def restore
    ...
    @conversation.hidden_for.delete(CURRENT_USER.to_s) if @conversation.hidden_for && @conversation.hidden_for.include?(CURRENT_USER.to_s)
    @conversation.save
